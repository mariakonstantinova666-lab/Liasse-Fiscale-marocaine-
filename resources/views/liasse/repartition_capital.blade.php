...
<div class="bg-white shadow-lg rounded-sm border border-slate-200 p-6">
    ...
    <div class="liasse-page-header">
        ...
        <span class="liasse-page-badge">Tableau T13</span>
    </div>
    ...
    <div class="overflow-x-auto">
        <table class="liasse-wide-data-table liasse-table-t13 w-full text-xs text-left border-collapse border border-slate-300">
            <colgroup>
