            ...
            <div class="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
                ...
                <section class="grid gap-6 xl:grid-cols-3">
                    <div class="ui-card p-5 sm:p-6 xl:col-span-2">
                        ...
                        <form v-else @submit.prevent="saveSociete" class="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                            ...
                            <div class="lg:col-span-3"><label class="mb-1.5 block text-sm font-semibold text-slate-700">Adresse</label><textarea v-model="societeForm.adresse" rows="3" class="ui-input resize-y"></textarea><p v-if="societeForm.errors.adresse" class="mt-1 text-xs text-rose-600">{{ societeForm.errors.adresse }}</p></div>
                ...
                <section class="ui-card p-5 sm:p-6">
                    ...
                    <form @submit.prevent="handleSubmit" class="mt-5 grid gap-4 md:grid-cols-4 md:items-end">
                        <div>
                            <label class="mb-1.5 block text-sm font-semibold text-slate-700">Annee d'exercice</label>
                        ...
                        <div class="md:col-span-2">
                            <label class="mb-1.5 block text-sm font-semibold text-slate-700">Fichier de la balance</label>
